...
public interface Sql {
	...
	public static final String CREATE_HOUSE = "UPDATE User SET house_handle=? WHERE username=?, password=?";
	public static final String GET_USER = "SELECT first_name, last_name, cell_number, emerg_number, email, house_handle FROM User WHERE username=? AND password=?";
