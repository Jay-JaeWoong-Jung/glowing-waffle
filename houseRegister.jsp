...
<input type="text" name="houseHandle" class="form-control" placeholder="123mainStreet" required autofocus>        <input type="hidden" name="command" value="creaetHouseHandle" >
